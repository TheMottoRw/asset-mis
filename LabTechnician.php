...
$employees = json_decode(curlGetRequest("LabTechnicianRequest.php?category=get"));
...
<div class="page-wrapper">
        ...
        <div class="main-content">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header border-bottom-0">
                            <h5 class="modal-title" id="exampleModalLabel">Add new lab technician</h5>
            ...
            <div id="response">
                ...
                if(isset($_POST['btnAdd'])){
                    ...
                    $response = json_decode(curlPostRequest("LabTechnicianRequest.php",$postData));

                    echo $response->message;
                }
                ?>
            </div>
            <table class="table table-borderless table-data3" id="data-lab-technicians">
                <thead>
                <tr>
                    <th>#</th>
                    <th>Names</th>
    ...
    <script>
        ...
        searchTable("#data-lab-technicians");
    </script>
</body>
