...
<div class="page-wrapper">
    ...
    <div class="page-container">
        ...
        <div class="main-content">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form class="px-4 py-3 color-black" action="<?= $_SERVER["PHP_SELF"]; ?>" method="post">
            ...
            <table class="table table-borderless table-data3" id="data-classes">
                <thead>
                <tr>
                    <th>#</th>
                    <th>Department</th>
                ...
                foreach ($classes as $k => $obj) {
                    ...
                    <tr>
                        ...
                        <td class="process">
                            <button type="button" onclick="confirmDelete(<?= $obj->id; ?>)" class="btn btn-danger"><i
